    ...
    <div class="bg-white shadow rounded-xl overflow-hidden">
        ...
        <div class="p-6 overflow-x-auto">
            ...
            <div class="flex flex-wrap items-center justify-between mb-4 space-y-2 sm:space-y-0">
                <div id="datatable-buttons" class="flex space-x-2 flex-wrap"></div>
                <div class="relative">
                    <input type="text" id="datatable-search" placeholder="Search..."
                        class="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
            </div>

            <table class="min-w-full text-sm text-left text-gray-600 datatable-AddItem">
...
<script>
    $(document).ready(function() {
        const table = $('.datatable-AddItem').DataTable({
            dom: 'Bfrtip',
            buttons: [
                {
                    extend: 'copyHtml5',
                    text: 'Copy',
                    className: 'bg-indigo-600 text-white px-3 py-1 rounded-md mr-1'
                },
                {
                    extend: 'csvHtml5',
                    text: 'CSV',
                ...
                @can('add_item_delete')
                {
                    ...
                    className: 'bg-red-600 text-white px-3 py-1 rounded-md mr-1',
