        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.partyDetail.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.party-details.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('place_of_supply') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="place_of_supply" id="place_of_supply" value="{{ old('place_of_supply', '') }}">
